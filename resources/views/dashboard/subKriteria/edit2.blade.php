        ...
        <div class="container-fluid px-4">
            ...
            <div class="card text-bg-light mb-4">
                <div class="card-header">
                    ...
                    Ubah Kriteria Resolusi Layar (C3)
                </div>
                <div class="card-body">
                    <form action="/dashboard/data-sub-kriteria2/{{ $subkriteria->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf

                        <div class="mb-3 row">
                            <label for="resolusiLayar" class="col-sm-2 col-form-label text-end fw-semibold text-secondary">Nama Sub Kriteria</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control @error('resolusiLayar')
                                  is-invalid
                              @enderror" id="resolusiLayar" value="{{ old('resolusiLayar', $subkriteria->resolusiLayar) }}" name="resolusiLayar" required>
                              @error('resolusiLayar')
                        ...
                        <div class="mb-3 row">
                            <label for="nResolusiLayar" class="col-sm-2 col-form-label text-end fw-semibold text-secondary">Nilai</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control @error('nResolusiLayar')
                                  is-invalid
                              @enderror" id="nResolusiLayar" value="{{ old('nResolusiLayar', $subkriteria->nResolusiLayar) }}" name="nResolusiLayar" required>
