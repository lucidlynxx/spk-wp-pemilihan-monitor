    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card text-bg-light mb-4">
                ...
                <div class="card-body">
                    <form action="/dashboard/data-sub-kriteria6/{{ $subkriteria->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf

                        <div class="mb-3 row">
                            <label for="colorGamut" class="col-sm-2 col-form-label text-end fw-semibold text-secondary">Nama Sub Kriteria</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control @error('colorGamut')
                                  is-invalid
                              @enderror" id="colorGamut" value="{{ old('colorGamut', $subkriteria->colorGamut) }}" name="colorGamut" required>
                              @error('colorGamut')
                        ...
                        <div class="mb-3 row">
                            <label for="nColorGamut" class="col-sm-2 col-form-label text-end fw-semibold text-secondary">Nilai</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control @error('nColorGamut')
                                  is-invalid
                              @enderror" id="nColorGamut" value="{{ old('nColorGamut', $subkriteria->nColorGamut) }}" name="nColorGamut" required>
                              @error('nColorGamut')
                                <div class="invalid-feedback">
                                  {{ $message }}
                                </div>
