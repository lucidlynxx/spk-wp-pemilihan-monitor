    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card text-bg-light mb-4">
                ...
                <div class="card-body">
                    <form action="/dashboard/data-sub-kriteria3/{{ $subkriteria->slug }}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf

                        <div class="mb-3 row">
                            <label for="teknologiPanel" class="col-sm-2 col-form-label text-end fw-semibold text-secondary">Nama Sub Kriteria</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control @error('teknologiPanel')
                                  is-invalid
                              @enderror" id="teknologiPanel" value="{{ old('teknologiPanel', $subkriteria->teknologiPanel) }}" name="teknologiPanel" required>
                        ...
                        <div class="mb-3 row">
                            <label for="nTeknologiPanel" class="col-sm-2 col-form-label text-end fw-semibold text-secondary">Nilai</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control @error('nTeknologiPanel')
                                  is-invalid
                              @enderror" id="nTeknologiPanel" value="{{ old('nTeknologiPanel', $subkriteria->nTeknologiPanel) }}" name="nTeknologiPanel" required>
